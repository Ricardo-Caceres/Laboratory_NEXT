...
export default function ClientExample({ codeContent }: { codeContent: { filePath: string; content: string }[] }) {
  ...
  return (
    <div className="flex flex-col lg:flex-row h-screen">
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center bg-gradient-to-br from-emerald-50 via-white to-teal-50 p-6 sm:p-8 overflow-y-auto">
