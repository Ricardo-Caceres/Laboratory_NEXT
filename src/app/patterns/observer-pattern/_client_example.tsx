...
export default function ClientExample({ codeContent }: { codeContent: { filePath: string; content: string }[] }) {
  ...
  return (
    <div className="flex flex-col lg:flex-row h-screen">
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center bg-gradient-to-br from-orange-50 via-white to-amber-50 p-6 sm:p-8 overflow-y-auto">
        <div className="w-full max-w-2xl">
          <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8 border border-gray-200">
            <div className="text-center mb-6">
              ...
              <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">Observer Pattern</h1>
              <p className="text-base sm:text-lg text-gray-600">Event-driven communication</p>
            </div>
            ...
            <div className="bg-gradient-to-b from-gray-50 to-white rounded-lg border border-gray-200 p-4 min-h-[200px] max-h-[300px] overflow-y-auto">
              <h3 className="font-semibold text-gray-900 mb-3">📬 Message Feed (Observer)</h3>
              {messages.length === 0 ? (
            ...
            <div className="mt-6 p-4 bg-orange-50 rounded-lg border border-orange-200">
              ...
              <ul className="text-sm text-gray-600 space-y-1">
                ...
                <li>✓ Perfect for event-driven architectures</li>
              </ul>
            </div>
          </div>
        </div>
