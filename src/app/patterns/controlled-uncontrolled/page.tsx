...
const Description = dynamic(() => import('./_description').then(mod => ({ default: mod.controlled''uncontrolledDescription })));

export default function controlled''uncontrolledPage() {
  return (
