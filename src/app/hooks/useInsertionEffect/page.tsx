import InsertionEffectExample from './_client_example';
import dynamic from 'next/dynamic';

const UseInsertionEffectDescription = dynamic(() => import('./_description').then(mod => ({ default: mod.UseInsertionEffectDescription })));
