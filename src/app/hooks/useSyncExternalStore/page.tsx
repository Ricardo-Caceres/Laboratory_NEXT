import SyncExternalStoreExample from './_client_example';
import dynamic from 'next/dynamic';

const UseSyncExternalStoreDescription = dynamic(() => import('./_description').then(mod => ({ default: mod.UseSyncExternalStoreDescription })));
      ...
      <div className="w-full lg:w-1/2 p-4 sm:p-6 overflow-y-auto bg-[var(--panel)]">
        <div className="mb-6 p-4 sm:p-6 bg-[var(--background)] rounded-lg border border-[var(--border)]">
          ...
          <div className="text-sm sm:text-base">
            <UseSyncExternalStoreDescription />
          </div>
        </div>
      </div>
